...
//				toMarginalize->frameID, smallestScore);
		if(toMarginalize) toMarginalize->flaggedForMarginalization = true;
		flagged++;
	}
...
void FullSystem::marginalizeFrame(FrameHessian* frame, bool deletable)
{
	...
	deleteOutOrder<FrameHessian>(frameHessians, frame, deletable);
