...
#define MAX_NUM_SHOW_FRAMES 10000
...
extern bool setting_GC_ON;
extern int setting_GCBoardType;
extern int setting_GCMaxFrames;
extern int setting_GCMinCornerCount;
extern float setting_GCMarkerLength;
extern float setting_GCMarkerSize[2];
extern float setting_GCChArUco_3X3_SquareLength;
extern float setting_GCChArUco_3X3_MarkerLength;
extern float setting_GCSmallMarkerLength;
extern float setting_GCErrorTH;
extern float setting_GCIntPtOptTH;
extern float setting_GCPlane3DPtOptTH;

extern Sophus::Matrix4f setting_groundRotate[SETTING_CHANNEL];
extern Sophus::Matrix4f setting_groundOffset[SETTING_CHANNEL];
extern Sophus::Matrix4f setting_groundScale[SETTING_CHANNEL];

extern double setting_maxDisplaydistance;
extern double setting_smallMarker2OrigXOffset;
extern double setting_smallMarker2OrigYOffset;
extern double setting_smallMarker2OrigZOffset;
...
extern bool setting_fullResetRequested[SETTING_CHANNEL];
extern bool setting_pauseRequested[SETTING_CHANNEL];
extern bool setting_needGroundCalibration[SETTING_CHANNEL];

extern bool setting_debugout_runquiet[SETTING_CHANNEL];
extern bool setting_useProfile[SETTING_CHANNEL];
...
extern bool setting_lostTrackerON;
extern int  setting_lostTrackerBackupFrames;
