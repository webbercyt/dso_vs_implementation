...
float setting_maxShiftWeightT= 0.04f * out_res;
float setting_maxShiftWeightR= 0.0f * out_res;
float setting_maxShiftWeightRT= 0.02f * out_res;
...
float setting_desiredImmatureDensity = 800; // immature points per frame default 1500
float setting_desiredPointDensity = 1000; // aimed total points in the active window. defulat 2000
...
bool  setting_GC_ON = false;
int   setting_GCBoardType = 0;				// type 0: single marker board; type 1: chess aruco 3x3 board	
int   setting_GCMaxFrames = 400;			
int   setting_GCMinCornerCount = 21;		// needed number of each corner 
float setting_GCMarkerLength = 0.406;
float setting_GCMarkerSize[2] = { 1.0, 1.0 };			// Marker Board Size [0]: width, [1]: height
float setting_GCChArUco_3X3_SquareLength = 10.0;
float setting_GCChArUco_3X3_MarkerLength = 5.0;
float setting_GCSmallMarkerLength = 0.046;
float setting_GCErrorTH = 0.004;			// threshold for bad error result verification
float setting_GCIntPtOptTH = 0.0001;		// optimization threshold to filter corner lines
float setting_GCPlane3DPtOptTH = 0.0001;

Sophus::Matrix4f setting_groundRotate[SETTING_CHANNEL] = { Sophus::Matrix4f::Identity(),Sophus::Matrix4f::Identity() };
Sophus::Matrix4f setting_groundOffset[SETTING_CHANNEL] = { Sophus::Matrix4f::Zero(),Sophus::Matrix4f::Identity() };
Sophus::Matrix4f setting_groundScale[SETTING_CHANNEL] = { Sophus::Matrix4f::Identity(),Sophus::Matrix4f::Identity() };

double setting_maxDisplaydistance = 30.0;
double setting_smallMarker2OrigXOffset = 0.0;
double setting_smallMarker2OrigYOffset = 0.0;
double setting_smallMarker2OrigZOffset = 0.0;
...
bool setting_fullResetRequested[SETTING_CHANNEL] = { false,false };
bool setting_pauseRequested[SETTING_CHANNEL] = { false,false };
bool setting_needGroundCalibration[SETTING_CHANNEL] = { false,false };

bool setting_debugout_runquiet[SETTING_CHANNEL] = { false,false };
bool setting_useProfile[SETTING_CHANNEL] = { false,false };

int sparsityFactor = 5;	// not actually a setting, only some legacy stuff for coarse initializer.

bool setting_lostTrackerON = false;
int  setting_lostTrackerBackupFrames = 50;
