...
public:
		...
		virtual void setNeedGroundCalibration(bool set) {};
		virtual void lockModel3DMutex() {};
		virtual void publishGroundCalibParams() {}; // call lockModel3DMutex() before this to avoid data conflict
		virtual void setMaxPCDist(float dist) {};
